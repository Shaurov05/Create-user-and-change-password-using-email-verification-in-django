"""
Django settings for verify_user project.
...
SECRET_KEY = '2$$%+x66xf8)4s!umw(hk7iy5so2yosyr2aa*)tc7=qy)4#5=%'
...
WSGI_APPLICATION = 'verify_user.wsgi.application'
